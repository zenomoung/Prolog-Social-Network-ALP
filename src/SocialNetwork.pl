...
:- chr_constraint expert/1, hasfollowers/1, worksin/3, boss/2, colleague/2, in_company/2, diff/2, adult/1, affiliated/3, manager/3, head/1, comrade/2.
...
studiedat(bob, econoemics, 2006, 2007).
